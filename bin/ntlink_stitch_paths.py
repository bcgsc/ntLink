...
class NtLinkPath:
    ...
    def parse_arguments():
        ...
        parser.add_argument("--max_gap", help="Maximum gap between contigs. -1 for no maximum gap size [-1]",
        ...
        parser.add_argument("--conservative", help="Conservative mode - take optimal N50 paths, no stitching",
                            action="store_true")
        parser.add_argument("-v", "--version", action='version', version='ntLink v1.3.10')
